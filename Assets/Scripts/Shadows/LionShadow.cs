...
public class LionShadow : Attributes
{
    public override string Name { get; set; } = "Lion";
    public override ShadowsID ID { get; set; } = ShadowsID.Lion;
    ...
    public override float InitialMarkingTimer { get; set; } = 7f;
    public override float MarkingTimer { get; set; } = 7f;
}
